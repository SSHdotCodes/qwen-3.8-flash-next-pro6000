# Historical snapshot — 2026-08-26

This is the README from commit `a76607d`. Its commands, precision settings,
speed figures, and causal interpretations are historical. Use the
[current README](../README.md) for the supported setup. In particular, the old
FlashInfer-autotune diagnosis was superseded by the SM120 QSA routing and
proposal-buffer findings. The old greedy measurements are not a comparison
against the September recommended-sampling results.
